...
class GeneticPlayer:
    def __init__(self, pop_size, num_generations, num_trials, window_size, hidden_size, board_size, mutation_chance=0.1,
                 mutation_size=0.1):
    ...
    def one_generation(self):
        ...
        # Testing if each brain is complete and they are all ranked
